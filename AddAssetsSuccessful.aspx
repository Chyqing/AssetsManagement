<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAssetsSuccessful.aspx.cs" Inherits="AssetsManagement.AddAssetsSuccessful" %>
    ...
    <div style="text-align:center;">
        <form id="form1" runat="server">
            <div style="width:302px;height:102px;margin: 100px auto;">
                ...
                <h2 style="float:left;margin-top:35px">入库成功！</h2>
                <div style="float:left;margin-top:35px;width:300px">
                    <div style="float:left;margin-left:25px;width:100px">
                        <asp:Button ID="Reapply" runat="server" Text="继续添加" BorderStyle="None" Font-Bold="True" Font-Size="18px" OnClick="BFApplication_Click" BackColor="#337AB7" BorderColor="#2A6DA4" ForeColor="White" />
                    </div>
